...
def plotter(count): 
    plt.clf()
    if count < 1:
        dir = 'C:/Users/uberg/Dropbox/Research/PDS70/Output/'
    else:
        dir = 'C:/Users/uberg/Dropbox/Research/PDS70/Output' + str(count) + '/'
    ...
    votable = parse("C:/Users/uberg/Dropbox/Research/PDS70/SED/vizier_votable.vot")
    ...
    data = np.loadtxt('C:/Users/uberg/Dropbox/Research/PDS70/Plots/lte44-4.5-0.0.spec.ascii')
    ...
    a = readsav('C:/Users/uberg/Dropbox/Research/PDS70/SED/psd70_irs.sav')
    ...
    plt.savefig('C:/Users/uberg/Dropbox/Research/PDS70/Plots/SEDs/SED' + str(count) + '.png', dpi = 300)
